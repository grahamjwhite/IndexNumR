...
test_that("volume indicator returns correct values for laspeyres method", {
  ...
  expect_equal(volumeIndicator(CES_sigma_2,
                              pvar = "prices",
                              qvar = "quantities",
                              prodID = "prodID",
                              pervar = "time",
...
test_that("volume indicator returns correct values for paasche method", {
...
test_that("volume indicator returns correct values for bennet method", {
...
test_that("volume indicator returns correct values for montgomery method", {
